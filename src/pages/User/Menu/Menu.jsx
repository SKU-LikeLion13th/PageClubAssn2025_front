      ...
      <div className="flex flex-col w-full mt-5">
        ...
        <div className="max-w-[500px]:w-full relative mb-5">
          ...
          <NavLink to="/Introduction">
            <button className="absolute w-[47%] h-[8.5%] top-[25.5%] max-w-[500px]:left-[45%] transform -translate-x-[40%] z-10">
          ...
          <NavLink to="/SNS">
            <button className="absolute w-[33%] h-[8.5%] top-[38.5%] max-w-[500px]:left-[50%] transform -translate-x-[48%] z-10">
          ...
          <NavLink to="/AboutUs">
            <button className="absolute w-[33%] h-[8.5%] top-[51%] max-w-[500px]:left-[30%] transform -translate-x-[40%] z-10">
              <div className="text-[150%] pr-8 text-[#3f3f3f] flex justify-center items-center">
                만든이들
              </div>
            </button>
