...
export default function YesRental() {
  const testUser = {
    name: "최유정",
    clubs: [
    ...
    reservation: [
      {
        itemName: "탁구채",
        image: images.testtg,
        rentalDate: "2024년 12월 23일",
      },
      {
        itemName: "탁구공",
        image: images.testball,
        rentalDate: "2025년 1월 6일",
      },
    ],
  };
          ...
          {testUser.reservation.length > 0 ? (
            <div className='flex flex-col items-center'>
              ...
              <div className="flex flex-col items-center py-5 text-center">
                ...
                />
                <div className='mb-5'>{testUser.reservation[currentReservationIndex].itemName}</div>
