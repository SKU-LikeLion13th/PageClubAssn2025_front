      ...
      <div className="flex flex-col w-full mt-5">
        ...
        <div className="max-w-[500px]:w-full relative">
          ...
          <NavLink to="/rentalitems">
            ...
            <button className="absolute w-[130px] h-12 top-[20%] max-w-[500px]:left-[30%] transform -translate-x-[65%] z-10"></button>
          </NavLink>
          <NavLink to="/member-card">
            <button className="absolute w-[130px] h-12 top-[33%] max-w-[500px]:left-[30%] transform -translate-x-[57%] z-10"></button>
          </NavLink>
          <NavLink to="/excellentclub">
            <button className="absolute w-[170px] h-12 top-[46%] max-w-[500px]:left-[30%] transform -translate-x-[37%] z-10"></button>
          </NavLink>
          <NavLink to="/classSchedule">
            <button className="absolute w-[140px] h-12 top-[58.5%] max-w-[500px]:left-[30%] transform -translate-x-[37%] z-10"></button>
          </NavLink>
        </div>
      </div>
    </div>
